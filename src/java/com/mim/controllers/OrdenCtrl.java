...
public class OrdenCtrl implements Serializable {
    ...
    private boolean zonaQuintanaRoo = true;
    private boolean zonaTabasco = true;
    ...
    public void validateZones() {
        if (user != null) {
            zonaQuintanaRoo = user.getQuintana() == 1;
            zonaTabasco = user.getTabasco() == 1;
        } else {
            System.out.println("ZONAS NO VALIDADAS");
        }
    }
...
private void ordenReport(Document document, Lugar lugar) throws BadElementException, DocumentException, IOException {
    ...
    public boolean isZonaQuintanaRoo() {
        return zonaQuintanaRoo;
    }

    public void setZonaQuintanaRoo(boolean zonaQuintanaRoo) {
        this.zonaQuintanaRoo = zonaQuintanaRoo;
    }

    public boolean isZonaTabasco() {
        return zonaTabasco;
    }

    public void setZonaTabasco(boolean zonaTabasco) {
        this.zonaTabasco = zonaTabasco;
    }
